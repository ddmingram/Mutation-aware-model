%%% Additional script that simulates the ODEs for a three-gene system. For
%%% more contextual info, see "doi.org/10.1101/2023.04.08.536106".
%%% Code author: Duncan Ingram, 2023.

function [dydt,y] = f_ODEs_3genes(t, y, params, subpops_up, z_values_up, z_values_dn)
...
dydt(x:x+n-1) = epsilon - (gamma_R*n_R + gamma_Z*n_Z + gamma_Q*n_Q...
              + gamma_HA.*n_HA + gamma_HB.*n_HB + gamma_HC.*n_HC)...
              - GR.*e; x=x+n;
%%% m_R
