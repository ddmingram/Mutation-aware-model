...
%%% For no I, or for I at unknown time
tspan = [0 1e9];
%%% For a specific signal
tspan1 = [0 0.5e4];
tspan2 = [0.5e4 1e4];

Opt_1 = odeset('RelTol',1e-3,'AbsTol',1e-6);
% Opt_1 = odeset('RelTol',1e-12,'AbsTol',1e-15);
